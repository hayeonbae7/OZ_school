...
function question(str) {
    ...
    const lowerCase = str.toLowerCase().match(pattern);
    const outputStr = lowerCase.join("");
    const reversedStr = outputStr.split("").reverse().join("");

    let result = outputStr === reversedStr;
